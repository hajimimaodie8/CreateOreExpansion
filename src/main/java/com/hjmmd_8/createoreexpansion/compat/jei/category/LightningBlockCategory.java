...
public class LightningBlockCategory extends ProcessingViaFanCategory.MultiOutput<LightningBlockRecipe> {

	public LightningBlockCategory(Info<LightningBlockRecipe> info) {
		super(info);
	}

	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, LightningBlockRecipe recipe, IFocusGroup focuses) {
	...
	@Override
	protected void renderWidgets(GuiGraphics graphics, LightningBlockRecipe recipe, double mouseX, double mouseY) {
	...
	@Override
	public void draw(LightningBlockRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX,
		double mouseY) {
