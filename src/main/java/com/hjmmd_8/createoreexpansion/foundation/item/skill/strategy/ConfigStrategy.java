...
public abstract class ConfigStrategy<P, C extends SkillConfig> implements SkillStrategy<P> {
    ...
    protected abstract boolean shouldRender(C config, ClientLevel world, IParams params);
    ...
    @Override
    public final boolean shouldRender(DataSkill skill, ClientLevel world, IParams params) {
