...
public class EnglishLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(AllMyItems.JADE_INGOT.get(), "Jade Ingot");
        add(AllMyItems.RAW_JADE.get(), "Raw Jade");
        add(AllMyItems.JADE_NUGGET.get(), "Jade Nugget");
        add(AllMyItems.CRUSHED_JADE_ORE.get(), "Crushed Jade Ore");
        add(AllMyItems.JADE_SMALL_SHARD.get(), "Small Jade Shard");
        add(AllMyItems.JADE_BIG_SHARD.get(), "Big Jade Shard");
        add(AllMyItems.JADE_SHEET.get(), "Jade Sheet");
        add(AllMyItems.JADE_ROD.get(), "Jade Rod");
        add(AllMyItems.JADE_WIRE.get(), "Jade Wire");
        add(AllMyItems.JADE_SWORD.get(), "Jade Sword");
        add(AllMyItems.JADE_PICKAXE.get(), "Jade Pickaxe");
        add(AllMyItems.JADE_AXE.get(), "Jade Axe");
        add(AllMyItems.JADE_SHOVEL.get(), "Jade Shovel");
        add(AllMyItems.TOPAZ_INGOT.get(), "Topaz Ingot");
        add(AllMyItems.RAW_TOPAZ.get(), "Raw Topaz");
        add(AllMyItems.TOPAZ_NUGGET.get(), "Topaz Nugget");
        add(AllMyItems.CRUSHED_TOPAZ_ORE.get(), "Crushed Topaz Ore");
        add(AllMyItems.TOPAZ_SMALL_SHARD.get(), "Small Topaz Shard");
        add(AllMyItems.TOPAZ_BIG_SHARD.get(), "Big Topaz Shard");
        add(AllMyItems.TOPAZ_SHEET.get(), "Topaz Sheet");
        add(AllMyItems.TOPAZ_ROD.get(), "Topaz Rod");
        add(AllMyItems.TOPAZ_WIRE.get(), "Topaz Wire");
        add(AllMyItems.TOPAZ_SWORD.get(), "Topaz Sword");
        add(AllMyItems.TOPAZ_PICKAXE.get(), "Topaz Pickaxe");
        add(AllMyItems.TOPAZ_AXE.get(), "Topaz Axe");
        add(AllMyItems.TOPAZ_SHOVEL.get(), "Topaz Shovel");
        add(AllMyItems.RAW_SAPPHIRE.get(), "Raw Sapphire");
        add(AllMyItems.SAPPHIRE_INGOT.get(), "Sapphire Ingot");
        add(AllMyItems.SAPPHIRE_NUGGET.get(), "Sapphire Nugget");
        add(AllMyItems.CRUSHED_SAPPHIRE_ORE.get(), "Crushed Sapphire Ore");
        add(AllMyItems.SAPPHIRE_SMALL_SHARD.get(), "Small Sapphire Shard");
        add(AllMyItems.SAPPHIRE_BIG_SHARD.get(), "Big Sapphire Shard");
        add(AllMyItems.SAPPHIRE_SHEET.get(), "Sapphire Sheet");
        add(AllMyItems.SAPPHIRE_ROD.get(), "Sapphire Rod");
        add(AllMyItems.SAPPHIRE_WIRE.get(), "Sapphire Wire");
        ...
        add(AllMyItems.SAPPHIRE_SWORD.get(), "Sapphire Sword");
        add(AllMyItems.SAPPHIRE_PICKAXE.get(), "Sapphire Pickaxe");
        add(AllMyItems.SAPPHIRE_AXE.get(), "Sapphire Axe");
        add(AllMyItems.SAPPHIRE_SHOVEL.get(), "Sapphire Shovel");
        ...
        add(AllMyItems.JADE_TOPAZ_BOW.get(), "Jade Topaz Bow");
