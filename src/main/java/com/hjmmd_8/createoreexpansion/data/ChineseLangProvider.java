...
public class ChineseLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        add(AllCreativeModeTabs.BASE_TAB.titleTranslationKey, "机械动力：矿物拓展");
        add(AllMyItems.JADE_INGOT.get(), "翡翠锭");
        add(AllMyItems.RAW_JADE.get(), "粗翡翠");
        add(AllMyItems.JADE_NUGGET.get(), "翡翠粒");
        add(AllMyItems.CRUSHED_JADE_ORE.get(), "粉碎翡翠矿石");
        add(AllMyItems.JADE_SMALL_SHARD.get(), "小块翡翠");
        add(AllMyItems.JADE_BIG_SHARD.get(), "大块翡翠");
        add(AllMyItems.JADE_SHEET.get(), "翡翠板");
        add(AllMyItems.JADE_ROD.get(), "翡翠棍");
        add(AllMyItems.JADE_WIRE.get(), "翡翠线");
        add(AllMyItems.JADE_SWORD.get(), "翡翠剑");
        add(AllMyItems.JADE_PICKAXE.get(), "翡翠镐");
        add(AllMyItems.JADE_AXE.get(), "翡翠斧");
        add(AllMyItems.JADE_SHOVEL.get(), "翡翠铲");
        add(AllMyBlocks.JADE_CASING.get(), "翡翠机壳");
        add(AllMyItems.TOPAZ_INGOT.get(), "黄玉锭");
        add(AllMyItems.RAW_TOPAZ.get(), "粗黄玉");
        add(AllMyItems.TOPAZ_NUGGET.get(), "黄玉粒");
        add(AllMyItems.CRUSHED_TOPAZ_ORE.get(), "粉碎黄玉矿石");
        add(AllMyItems.TOPAZ_SMALL_SHARD.get(), "小块黄玉");
        add(AllMyItems.TOPAZ_BIG_SHARD.get(), "大块黄玉");
        add(AllMyItems.TOPAZ_SHEET.get(), "黄玉板");
        add(AllMyItems.TOPAZ_ROD.get(), "黄玉棍");
        add(AllMyItems.TOPAZ_WIRE.get(), "黄玉线");
        add(AllMyItems.TOPAZ_SWORD.get(), "黄玉剑");
        add(AllMyItems.TOPAZ_PICKAXE.get(), "黄玉镐");
        add(AllMyItems.TOPAZ_AXE.get(), "黄玉斧");
        add(AllMyItems.TOPAZ_SHOVEL.get(), "黄玉铲");
        add(AllMyItems.SAPPHIRE_INGOT.get(), "蓝宝石锭");
        add(AllMyItems.RAW_SAPPHIRE.get(), "粗蓝宝石");
        add(AllMyItems.SAPPHIRE_NUGGET.get(), "蓝宝石粒");
        add(AllMyItems.CRUSHED_SAPPHIRE_ORE.get(), "粉碎蓝宝石矿石");
        add(AllMyItems.SAPPHIRE_SMALL_SHARD.get(), "小块蓝宝石");
        add(AllMyItems.SAPPHIRE_BIG_SHARD.get(), "大块蓝宝石");
        add(AllMyItems.SAPPHIRE_SHEET.get(), "蓝宝石板");
        add(AllMyItems.SAPPHIRE_ROD.get(), "蓝宝石棍");
        add(AllMyItems.SAPPHIRE_WIRE.get(), "蓝宝石线");
        ...
        add(AllMyItems.SAPPHIRE_SWORD.get(), "蓝宝石剑");
        add(AllMyItems.SAPPHIRE_PICKAXE.get(), "蓝宝石镐");
        add(AllMyItems.SAPPHIRE_AXE.get(), "蓝宝石斧");
        add(AllMyItems.SAPPHIRE_SHOVEL.get(), "蓝宝石铲");
        ...
        add(AllMyItems.JADE_TOPAZ_BOW.get(), "翠玉之弓");
